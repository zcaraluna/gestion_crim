# 🚀 Guía de Configuración - CRIMIGESTOR
...
```bash
# Database
DATABASE_URL="postgresql://usuario:contraseña@localhost:5432/crimigestor?schema=public"
```
...
- `crimigestor`: Nombre de la base de datos

**Ejemplo:**
```env
DATABASE_URL="postgresql://postgres:mi_password@localhost:5432/crimigestor?schema=public"
```
...
- Crea la base de datos manualmente: `CREATE DATABASE crimigestor;`
